...
// Include JIT header for coverage stuff
...
void MainWindow::ConnectToolBar()
{
  ...
  // Coverage widget
  connect(m_tool_bar, &ToolBar::SaveCoveragePressed, this, &MainWindow::SaveCoverageData);
}

// Select the DOL file, then invoke the coverage saver thingy
void MainWindow::SaveCoverageData()
{
  QStringList dol_files = PromptFileNames();
  if (!dol_files.isEmpty())
  {
    std::string file_path = dol_files.front().toStdString();
    Jit64::SaveCoverageData(file_path);
  }
}
