...
void ToolBar::OnEmulationStateChanged(Core::State state)
{
  ...
  m_save_coverage_action->setEnabled((running || paused) && SConfig::GetInstance().bEnableCodeCoverage);
}
...
void ToolBar::MakeActions()
{
  ...
  addSeparator();
  m_save_coverage_action = addAction(tr("Save Coverage"), this, &ToolBar::SaveCoveragePressed);
...
void ToolBar::UpdateIcons()
{
  ...
  // Coverage button icon is the debug save icon
  m_save_coverage_action->setIcon(Resources::GetScaledThemeIcon("debugger_save"));
}
